        ...
        <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul className="space-y-2 font-medium">
              ...
              <NavLink
                ...
                {({ isActive }) => (
                  <>
                  <FaChartPie color={isActive ? "" : ""}/>
                  <svg className={`flex-shrink-0 w-5 h-5 ${isActive ? 'text-gray-500' : 'text-gray-900'} transition duration-75   group-hover:text-gray-900`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
