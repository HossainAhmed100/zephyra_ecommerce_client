...
function FlashSalesProduct({product}) {
    console.log("🚀 ~ FlashSalesProduct ~ product:", product)
  ...
  return (
    ...
    <Card className="pb-4 hover:border-1 hover:border-gray-100 transition shadow-none duration-700 ease-in-out border-1 border-transparent">
      ...
      <CardBody className="overflow-visible items-center p-6 bg-gray-100">
      <Image
        alt="Card background"
